...
Notes:
    ...
    Also:
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/mkinit/versions/
"""
#
...
mod_dpath = join(repo_dpath, 'mkinit')
...
# html_favicon = '.static/mkinit.ico'
...
latex_documents = [
    (master_doc, 'mkinit.tex', 'mkinit Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'mkinit', 'mkinit Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mkinit', 'mkinit Documentation',
     author, 'mkinit', 'One line description of project.',
     'Miscellaneous'),
]
