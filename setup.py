...
def parse_version(fpath):
    ...
    """
    return static_parse("__version__", fpath)
...
if __name__ == "__main__":
    ...
    setupkw["url"] = "https://github.com/Erotemic/mkinit"
    setupkw["description"] = "Autogenerate __init__.py files"
