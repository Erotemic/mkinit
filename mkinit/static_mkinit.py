...
def autogen_init(modpath_or_name, imports=None, respect_all=True, options=None,
                 dry=False):
    """
...
def static_init(modpath_or_name, imports=None, respect_all=True, options=None):
    """
...
def _static_parse_imports(modpath, submodules=None, respect_all=True):
    ...
    Example:
        ...
        >>> tup = _static_parse_imports(modpath)
